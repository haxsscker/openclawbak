...
![Google SSO示例](https://example.com/google-sso.png)
...
![SAML三个核心角色](https://example.com/saml-roles.png)
...
![SAML认证流程](https://example.com/saml-flow.png)
...
![SAML元数据交换](https://example.com/saml-metadata.png)
...
![认证流程](https://example.com/auth-flow.png)
...
![IDP发起流程](https://example.com/idp-initiated.png)
...
![SP发起流程](https://example.com/sp-initiated.png)
...
![流程对比](https://example.com/flow-comparison.png)

---

## 四、完整流程总览

![完整流程](https://example.com/complete-flow.png)
