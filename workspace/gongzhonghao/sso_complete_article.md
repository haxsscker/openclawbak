---
title: 单点登录（SSO）完整图解
cover: /root/.openclaw/workspace/gongzhonghao/cover.jpg
---
...
![SAML元数据交换](/root/.openclaw/workspace/mermaid-cli/oauth_sequence.png)
...
![认证流程](/root/.openclaw/workspace/mermaid-cli/auth-flow.png)
...
![IDP发起流程](/root/.openclaw/workspace/mermaid-cli/idp-flow.png)
...
![SP发起流程](/root/.openclaw/workspace/mermaid-cli/sp-flow.png)
...
这个对比图已经包含在上面的SP发起流程图中。

---

## 四、完整流程总览

![完整流程](/root/.openclaw/workspace/mermaid-cli/complete-flow.png)
